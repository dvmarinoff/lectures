...
// new:
- DOM
- DOM API 	- the lib for manipulation of the DOM

- document  - the entry point to the DOM
- HTMLElement 	- inherits all other elments
...
getElemenrByName() - useful for forms
getElementByTagName('ul')[0] - returns the first ul from the collection of uls

- changing

getElementBy - returns an object or collection of objects
innerHTML 	 - returns the content like a string without the element
outerHTML 	 - returns both
